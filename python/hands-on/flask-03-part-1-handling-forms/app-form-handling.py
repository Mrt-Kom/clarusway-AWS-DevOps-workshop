...
@app.route("/")
def home():
    return render_template("index.html", name="Murat")

# Write a function named `greet` which uses template file named `greet.html` given under `templates` folder
# send your name as template variable, and assign route of  ('/greet')
...
def greet():
    if "user" in request.args:
        ...
        return render_template("greet.html",user="Send your user name with 'user' param in query")
